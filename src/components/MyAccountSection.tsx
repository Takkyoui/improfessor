  ...
  return (
    <>
      <div className="flex flex-col items-start gap-12 self-stretch">
        <h1 className="text-3xl font-bold text-white">내 계정</h1>
        ...
        <div className="inline-flex pl-10 flex-col justify-center items-start gap-[49px]">
          ...
          <div className="flex items-center gap-5">
            ...
            <input
              ...
              value={user.email}
              disabled
              className="flex w-[328px] h-[41px] px-[14px] py-2 items-center gap-2 text-white rounded-[10px] border border-white/60 bg-white/30 focus:outline-none cursor-not-allowed"
            />
          </div>

          {/* 사용자 닉네임 */}
          <div className="flex items-center gap-5">
            <label className="text-sm font-medium text-white whitespace-nowrap w-[120px]">사용자 닉네임</label>
            <input
              type="text"
              value={user.nickname}
              disabled
          ...
          {/* 대학교 */}
          <div className="flex items-center gap-5">
            <label className="text-sm font-medium text-white whitespace-nowrap w-[120px]">대학교</label>
            <div className="flex gap-4 lg:gap-[25px]">
              <input
                type="text"
                value={displayUniversity}
                onChange={(e) => setUniversity(e.target.value)}
                placeholder="대학교를 입력해주세요"
                className="flex w-[328px] h-[41px] px-[14px] py-2 items-center gap-2 text-white rounded-[10px] border border-white/60 bg-white/30 focus:outline-none"
                readOnly
              />
              <button
                type="button"
                onClick={() => setIsUniversityModalOpen(true)}
                className="flex h-[41px] px-6 justify-center items-center text-white rounded-[10px] bg-white/30 hover:bg-white/40 transition whitespace-nowrap"
              >
                검색
              </button>
            </div>
          ...
          {/* 학과 */}
          <div className="flex items-center gap-5">
            <label className="text-sm font-medium text-white whitespace-nowrap w-[120px]">학과</label>
            <div className="flex gap-4 lg:gap-[25px]">
              <input
                type="text"
                value={displayMajor}
              ...
              <button
                ...
                className="flex h-[41px] px-6 justify-center items-center text-white rounded-[10px] bg-white/30 hover:bg-white/40 transition whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
              >
                검색
              </button>
            </div>
          ...
          <button
            ...
            className="flex w-[328px] h-[41px] px-[24.957px] justify-center items-center flex-shrink-0 text-white rounded-[10px] bg-[rgba(72,86,105,0.80)] shadow-[0_0_4px_0_rgba(255,255,255,0.50)] hover:bg-[rgba(72,86,105,0.90)] transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
